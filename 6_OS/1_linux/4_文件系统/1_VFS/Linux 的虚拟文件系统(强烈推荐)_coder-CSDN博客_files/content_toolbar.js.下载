...
// 判断当前日期是否处在节日范围(圣诞节、元旦）
// 圣诞节 时间提前一点（2019-12-24 00:00:00 - 2019-12-26 00:00:00）
// 元旦（2020-01-01 00:00:00 - 2020-01-02 00:00:00）
function isFestivalRange (day) {
  var start_time,
      end_time,
      now_time = Math.floor(Date.now() / 1000), // 当前时间戳
      christmas_start_time = getTimestamp('2019-12-24 00:00:00'),
      christmas_end_time = getTimestamp('2019-12-26 00:00:00'),
      newYearsDay_start_time = getTimestamp('2020-01-01 00:00:00'),
      newYearsDay_end_time = getTimestamp('2020-01-02 00:00:00');
  if (day === 'christmas') {
    start_time = christmas_start_time;
    end_time = christmas_end_time;
  } else {
    start_time = newYearsDay_start_time;
    end_time = newYearsDay_end_time;
  }
...
function setFestiveLogo () {
  var logo_tpl, 
      ...
      csdnlogo_christmas = window.csdn.toolbarIsBlack
       ? prefix + 'csdnlogo-black-christmas.gif'
       : prefix + 'csdnlogo-christmas.gif',
      csdnlogo_newYearsDay = window.csdn.toolbarIsBlack
       ? prefix + 'csdnlogo-black-newYearsDay.gif'
       : prefix + 'csdnlogo-newYearsDay.gif';
  if (isFestivalRange('christmas')) {
    logo_tpl = '<img src="' + csdnlogo_christmas + '">';
    logo_title = '圣诞节';
    return { logo_tpl: logo_tpl, logo_title: logo_title };
  }
  if (isFestivalRange('newYearsDay')) {
    logo_tpl = '<img src="' + csdnlogo_newYearsDay + '">';
    logo_title = '元旦';
    return { logo_tpl: logo_tpl, logo_title: logo_title };
  }
}
        ...
        <div class="container row center-block " id="csdn_container_tool">\
          ...
          <div class="pull-right onlyUser searchUser login-wrap '+ loginMark + '">\
            <ul class="btns">\
              ...
              <a class="" id="remind" href="#"><img src="https://csdnimg.cn/public/common/toolbar/images/messageIcon.png" alt="" class="message"><div class="toolbar-circle" id="msg-circle"></div></a>\
